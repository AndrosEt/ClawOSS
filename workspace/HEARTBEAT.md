...
## TOP RULES
- Keep all 5 sub-agent slots filled. Empty slot = wasted throughput.
- Follow-ups FIRST, then new implementations. They share the 5-slot pool.
- Work queue should have 10+ items. If < 5, run oss-discover IMMEDIATELY.
- See AGENTS.md for safety rules and contribution types.
