...
// LLM model and pricing from env vars (generic — supports any OpenAI-compatible model)
const LLM_MODEL = process.env.LLM_MODEL || "unknown";
const LLM_PROVIDER = process.env.LLM_PROVIDER || "configured";
const INPUT_COST_PER_TOKEN = parseFloat(process.env.LLM_INPUT_COST_PER_MILLION || "0") / 1_000_000;
const OUTPUT_COST_PER_TOKEN = parseFloat(process.env.LLM_OUTPUT_COST_PER_MILLION || "0") / 1_000_000;
