...
**Gate 1 — Scope**: Changes related to target issue only, no unrelated files, <200 LOC. Every changed line must be necessary. Multi-file changes are fine if the scope demands it.
