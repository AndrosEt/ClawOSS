...
class GhosttyNSView: NSView, NSUserInterfaceValidations {
    ...
    override func mouseDown(with event: NSEvent) {
        ...
        // Only update mouse position on the first click to prevent cursor movement
        // during double-click selection gestures. The selection logic handles
        // multi-clicks internally without needing position updates on each click.
